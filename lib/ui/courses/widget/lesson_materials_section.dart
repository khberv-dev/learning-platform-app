...
/// Handouts attached to a lesson, as bundled into its detail response. PDFs
/// open in the in-app reader; Word files hand off to whatever the device has
/// installed.
///
/// Supplementary to the lesson itself, so it takes up no room when the lesson
/// has none.
class LessonMaterialsSection extends ConsumerWidget {
  final List<LessonMaterialEntity> materials;

  const LessonMaterialsSection({super.key, required this.materials});
      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            Text(
              AppLocalizations.of(context).materialsFileCount(materials.length),
