...
Future<void> showBookMentorSheet(
  ...
  await showModalBottomSheet<void>(
    ...
    builder: (_) => UncontrolledProviderScope(
      ...
      child: _BookMentorSheet(mentorId: mentorId, mentorName: mentorName),
    ),
  );
}

class _BookMentorSheet extends ConsumerStatefulWidget {
  final String mentorId;
  final String mentorName;

  const _BookMentorSheet({required this.mentorId, required this.mentorName});

  @override
  ConsumerState<_BookMentorSheet> createState() => _BookMentorSheetState();
}

class _BookMentorSheetState extends ConsumerState<_BookMentorSheet> {
  ...
  Widget build(BuildContext context) {
    final scheduleState = ref.watch(mentorScheduleProvider(widget.mentorId));
          ...
          Padding(
            ...
            child: Column(
              children: [
                ...
                Text(
                  l10n.bookSubtitle(widget.mentorName),
                  style: const TextStyle(
